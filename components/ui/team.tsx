...
const teamMembers = [
  {
    image: "/team/Sajid Ali.jpeg",
    name: "Sajid",
    role: "Founder & CEO",
  },
  {
    image: "/team/Ali Haider.jpeg",
    name: "Ali haider",
    role: "Co-Founder & Brand Director",
  },
  {
    image: "/team/Daniyal Hussain.jpeg",
    name: "Daniyal Hussain",
    role: "Finance Director",
  },
  {
    image: "/team/Shehzad.jpeg",
    name: "Shehzad Ali",
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        <div className="mx-auto mb-16 flex max-w-5xl flex-col items-center px-6 text-center lg:px-0">
          ...
          <p className="max-w-2xl text-neutral-600 dark:text-neutral-400">
            Our experienced founders, advisors, and logistics managers are
            dedicated to curating the most authentic and breathtaking travel
        ...
        <div className="mx-auto mt-20 max-w-3xl px-6 text-center lg:px-0">
          <p className="mb-8 font-medium text-lg text-neutral-900 leading-relaxed md:text-xl dark:text-neutral-100">
            "Safar Silsila made our dream trip to Hunza and Skardu a reality. From
            the comfortable transport to the warm hospitality of their local hosts,
            every detail was carefully customized for our family!"
          </p>
